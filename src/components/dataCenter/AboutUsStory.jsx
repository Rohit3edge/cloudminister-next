                    ...
                    {serverManagementData?.map((item, index) => (
                      <div className="col" key={index}>
                        <div className="tech-partner transition bg-white px-6 py-8 rounded-2 text-center h-100 border border-dark border-opacity-10">
                          ...
                          <Link href={item.href ? item.href : "#"}  className="fs-18  mt-4 text-decoration-none d-inline-flex align-items-center " style={{ cursor: 'pointer',color:"#000" ,fontWeight:"400"}}>
                            {item.title}
                          </Link>
                        </div>
                      </div>
