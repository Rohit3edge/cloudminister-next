    ...
    <>
      ...
      <section className="container py-5 mt-10 mb-10">
        <h2 className="text-center mb-5">
          Why choose Akamai Linode with CloudMinister?
        </h2>
        <p className="text-center mb-5 max-24 mb-4">
          CloudMinister brings to you the seamless Akamai Linode, an absolute
          cloud solution that has been developed for unmatched business
          benefits.
        </p>
