                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="card support-card h-100 d-flex flex-column justify-content-between">
                      <div className="card-body p-xl-6" >
                        ...
                        <a className="text-decoration-none d-inline-flex align-items-center gap-2 text-dark fw-semibold btn-arrow mb-3">
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="card support-card h-100 d-flex flex-column justify-content-between">
                      <div className="card-body p-xl-6">
                        ...
                        <a href="mailto:support@cloudminister.com" className="text-decoration-none d-inline-flex align-items-center gap-2 text-dark fw-semibold btn-arrow mb-3">
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="card support-card h-100 d-flex flex-column justify-content-between">
                      <div className="card-body p-xl-6">
                        ...
                        <p>+91-8447755312</p>
                        <a href="tel:+918447755312" className="text-decoration-none d-inline-flex align-items-center gap-2 text-dark fw-semibold btn-arrow mb-3">
                          <span className="d-inline-block btn-arrow__text">
                            Call Now
                            <span className="btn-arrow__icon">
                              <i className="las la-arrow-right"></i>
