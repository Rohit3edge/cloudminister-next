          ...
          <div className="row align-items-center">
            <div className="col-lg-7 col-xl-6">
              ...
              <small className="d-inline-block mb-2 fw-bold bg-success-subtle text-success-emphasis border border-success-subtle px-3 py-1 rounded">
                <span className="d-inline-block w-2 h-2 bg-success rounded-circle me-1">
                  {" "}
                </span>
                Migrate to Akamai
              </small>
              ...
              >
                Cloud Hosting –<span className="text-success-new">Akamai</span>{" "}
              ...
              <p
                ...
                data-sal-easing="ease-in-out-sine"
              >
                Take your business to new heights with Akamai's powerful cloud
                hosting solutions. With unmatched speed, superior security, and
                maximum uptime, your website will keep running flawlessly. To
                give you exactly what you need from a performance and
                reliability standpoint, Akamai offers a robust set of plans.
                Stay ahead of competition with quick response times and a
                hosting partner you can count on. Your success begins with
                Akamai.
              </p>
